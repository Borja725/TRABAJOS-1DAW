...
CREATE SCHEMA IF NOT EXISTS `lliga1213` DEFAULT CHARACTER SET latin1 ;
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (5,'Ast�ries',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (6,'�vila',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (12,'C�ceres',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (13,'Cadis',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (14,'Cant�bria',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (15,'Castell�',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (18,'C�rdova',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (19,'Cornell� de Llobregat',85000);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (25,'Guip�scoa',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (28,'Ja�n',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (33,'Lle�',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (36,'M�laga',568000);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (37,'Melilla',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (38,'M�rcia',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (42,'Pal�ncia',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (47,'Sant Sebasti�',186000);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (50,'Seg�via',NULL);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (51,'Sevilla',702000);
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (52,'S�ria',NULL);
...
INSERT INTO `ciutats` (`codi`,`nom`,`habitants`) VALUES (56,'Val�ncia',798000);
...
*/
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('ath','Athletic','Athletic Club',9,'Marcelo Bielsa','Estadio de San Mam�s','Umbro','Petronor',58);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('atm','At. Madrid','Club Atl�tico de Madrid',35,'Diego Simeone','Vicente Calder�n','Nike','Azerbaiy�n',120);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('bar','Bar�a','Futbol Club Barcelona',8,'Tito Vilanova','Camp Nou','Qatar Foundation','UNICEF',470);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('bet','Real Betis','Real Betis Balompi�',51,'Pepe Mel','Benito Villamar�n','Cirsa','Andaluc�a',40);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('cel','Celta de Vigo','Real Club Celta de Vigo',58,'Abel Resino','Estadio de Bala�dos','Adidas','Citro�n',33);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('dep','Deportivo','Real Club Deportivo de La Coru�a',29,'Fernando V��quez Pena','Riazor','Lotto Sport Italia','Hijos de Rivera',40);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('esp','Espanyol','Reial Club Deportiu Espanyol',8,'Javier Aguirre','Cornell�-El Prat','Puma','Canc�n',46);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('gda','Granada','Granada Club de F�tbol',23,'Lucas Alcaraz','Los C�rmenes','Caja Granada','',30);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('get','Getafe','Getafe Club de F�tbol',21,'Luis Garc�a Plaza','Coliseum Alfonso P�rez','Joma','',42);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('lev','Llevant','LLevant Uni� Esportiva',56,'Juan Ignacio Mart�nez Jim��ez','Ciutat de Val�ncia','Kelme','Comunitat Valenciana',22);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('mal','Mallorca','Real Club Deportivo Mallorca',43,'Gregorio Manzano','Iberostar Estadio','Riviera Maya','Sol Meli�',31);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('mga','M�laga','M�laga Club de F�tbol',36,'Manuel Pellegrini','Estadio La Rosaleda','Unesco','Porsche',80);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('osa','Osasuna','Club Atl�tico Osasuna',44,'Jos� Luis Mendil�bar','Reyno de Navarra','','',30);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('ray','Rayo Vallecano','Rayo Vallecano de Madrid',35,'Paco Jim�nez','Campo de F�tbol de Vallecas','Erre�','',8);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('rma','Real Madrid','Real Madrid Club de F�tbol',35,'Jos� Mourinho','Santiago Bernab�u','Adidas','',517);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('rso','Real Sociedad','Real Sociedad de F�tbol',47,'Philippe Montanier','Anoeta','Canal+','Kutxa',43);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('sev','Sevilla','Sevilla F�tbol Club',51,'Unai Emery','Ram�n S�nchez Pizju�n','','',60);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('vad','Valladolid','Real Valladolid Club de F�tbol',57,'Miroslav ?uki?','Estadio Jos� Zorrilla','Kappa','El Norte de Castilla',23);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('val','Val�ncia','Val�ncia Club de Futbol',56,'Ernesto Valverde','Mestalla','','',103);
INSERT INTO `equips` (`codi`,`nomcurt`,`nomllarg`,`ciutat`,`entrenador`,`estadi`,`marca`,`patrocinador`,`pressupost`) VALUES ('zar','Zaragoza','Real Zaragoza',49,'Manolo Jim�nez Jim�nez','La Romareda','Telef�nica','Canal+',0);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',6,'Mikel San Jos�','mig',4310000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',10,'�scar de Marcos','mig',4710000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',11,'Ibai G�mez','mig',4010000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',13,'Ra�l Fern�ndez','porter',470000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',16,'Isma L�pez','defensa',1810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',17,'I�igo P�rez','defensa',1820000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',26,'Igor Mart�nez','defensa',1910000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ath',39,'Mor�n','defensa',2040000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',1,'Sergio Asenjo','porter',440000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',2,'Diego God�n','mig',3960000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',3,'Filipe Lu�s','mig',3660000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',4,'Mario Su�rez','mig',3360000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',7,'Adri�n L�pez','mig',3960000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',8,'Ra�l Garc�a','mig',4260000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',11,'Cristi�n Rodr�guez','mig',3660000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',18,'Cata D�az','defensa',2420000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',22,'Ins�a','defensa',2460000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',28,'Sa�l','defensa',2520000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',30,'�liver Torres','defensa',2540000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',31,'Borja Gal�n','defensa',2550000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('atm',34,'Iv�n Calero','defensa',2580000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',1,'V�ctor Vald�s','porter',3040000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',2,'Dani Alves','defensa',2740000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',3,'Gerard Piqu�','mig',3360000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',4,'Cesc F�bregas','davanter',5360000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',8,'Andr�s Iniesta','mig',3660000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',9,'Alexis S�nchez','davanter',4560000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',10,'Lionel Messi','davanter',12860000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',11,'Thiago Alc�ntara','mig',3260000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',12,'Jonathan dos Santos','defensa',2840000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',13,'Jos� Manuel Pinto','porter',1000000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bar',17,'Pedro Rodr�guez','mig',3960000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',3,'Mario �lvarez','mig',2360000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',4,'Amaya','defensa',1460000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',6,'�lex Mart�nez','defensa',1480000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',7,'�ngel L�pez','mig',1360000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',8,'Rub�n P�rez','mig',2660000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',9,'Vadillo','defensa',1510000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',10,'Be�at','mig',4160000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',11,'Alejandro Pozuelo','mig',1560000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',12,'Paul�o','mig',2660000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',13,'Adri�n San Miguel','porter',2810000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',21,'Ca�as','defensa',1630000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',24,'Rub�n Castro','davanter',6760000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',34,'Carlos Garc�a','defensa',1760000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('bet',39,'Sergio Rodr�guez','defensa',1810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',1,'Sergio �lvarez','porter',340000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',4,'Borja Oubi�a','mig',3760000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',5,'T��ez','defensa',1670000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',6,'Jonathan Vila','defensa',1680000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',8,'�lex L�pez','mig',3660000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('cel',24,'Augusto Fern�ndez','mig',4760000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',4,'Alex Berganti�os','mig',3060000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',5,'Z� Castro','defensa',1860000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',6,'Aythami','defensa',1870000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',8,'Andr� Santos','defensa',1890000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',9,'Pizzi','davanter',4960000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',10,'Juan Dom�nguez','mig',2460000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',11,'Riki','davanter',6060000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',12,'Paulo Assun��o','defensa',1930000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',13,'Germ�n Lux','porter',530000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',18,'Javier Camu�as','mig',2660000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',19,'S�lvio','mig',2060000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',20,'Jes�s V�zquez','defensa',2010000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',21,'Juan Carlos Valer�n','mig',3360000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',22,'Diogo Salom�o','mig',1560000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',23,'Kak�','defensa',2040000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',24,'Carlos Marchena','mig',2760000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',25,'N�lson Oliveira','mig',3460000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('dep',28,'Ins�a','defensa',2090000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',1,'Cristian �lvarez','porter',1580000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',2,'Mattioni','defensa',1880000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',3,'Ra�l Rodr�guez','defensa',1890000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',4,'V�ctor S�nchez','mig',3520000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',5,'Tejera','mig',1520000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',6,'Forl�n','defensa',1920000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',9,'Sergio Garc�a','davanter',4120000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',10,'Joan Verd�','davanter',5420000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',15,'H�ctor Moreno','mig',3820000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',16,'Javi L�pez','mig',3320000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',20,'Sim�o Sabrosa','mig',3120000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',22,'Wakaso Mubarak','mig',3220000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',23,'Cristian G�mez','defensa',2090000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',27,'V�ctor �lvarez','defensa',2130000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',35,'Germ�n','defensa',2210000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('esp',46,'De Amo','defensa',2320000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',1,'To�o','porter',2210000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',8,'I�igo L�pez','defensa',1710000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',11,'Dani Ben�tez','mig',1280000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',12,'Diego Buonanotte','mig',2480000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',13,'Roberto Fern�ndez','porter',1120000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',14,'Mikel Rico','mig',4080000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',15,'Diakhat�','defensa',1780000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('gda',20,'Borja G�mez','defensa',1830000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',1,'Miguel �ngel Moy�','porter',2750000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',2,'Alexis Ruano','mig',3440000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',3,'Man�','mig',1540000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',7,'�lvaro V�zquez','mig',4140000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',8,'Sarabia','defensa',1830000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',9,'Paco Alc�cer','mig',2740000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',10,'Gavil�n','defensa',1850000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',11,'Adri�n Colunga','mig',3540000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',12,'Fede Fern�ndez','mig',1640000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',13,'Jordi Codina','porter',810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',14,'Pedro Le�n','mig',3440000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',18,'�ngel Lafita','mig',3040000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',21,'M�chel','defensa',1960000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',22,'Juan Rodr�guez','mig',1540000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('get',23,'Borja Fern�ndez','mig',2040000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',1,'Gustavo Mun�a','porter',2700000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',4,'David Navarro','mig',3610000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',5,'H�ctor Rodas','defensa',1680000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',6,'Vyntra','defensa',1690000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',7,'Jos� Barkero','mig',4010000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',11,'Rub�n Garc�a','mig',3810000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',16,'Pedro R�os','mig',2610000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',19,'Pedro L�pez','defensa',1820000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',20,'Juanlu','mig',2710000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',21,'M�chel Herrero','mig',4410000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',24,'Sim�o','defensa',1870000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',26,'Garabato','defensa',1890000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',27,'Roger Mart�','mig',1910000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('lev',28,'Iv�n L�pez','defensa',1910000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',3,'Jo�o Victor','defensa',1510000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',4,'Anderson Concei�ao','defensa',1520000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',5,'Pina','defensa',1530000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',6,'Antonio L�pez','defensa',1540000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',11,'Javi M�rquez','mig',2750000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',18,'V�ctor','davanter',4750000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',19,'Mart�','defensa',1670000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',23,'Kevin Mart�nez','mig',1450000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',24,'Font�s','defensa',1720000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',25,'Rub�n Mi�o','porter',230000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',30,'�lvaro','defensa',1780000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mal',35,'Marc Fern�ndez','defensa',1830000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',1,'Carlos Kameni','porter',500000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',2,'Jes�s G�mez','defensa',1720000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',5,'Mart�n Demichelis','mig',4070000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',6,'Ignacio Camacho','mig',3770000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',7,'Joaqu�n','mig',4270000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',10,'J�lio Baptista','mig',2070000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',11,'Seba Fern�ndez','defensa',1810000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',21,'Sergio S�nchez','defensa',1910000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('mga',46,'�lex Portillo','defensa',2160000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',1,'Riesgo','defensa',1490000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',2,'Marc Bertr�n','defensa',1500000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',3,'Rub�n','defensa',1510000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',4,'Miguel Fla�o','defensa',1520000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',10,'Pu�al','defensa',1580000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',13,'Andr�s Fern�ndez','porter',3260000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',16,'�lvaro Cejudo','mig',3380000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',23,'Raoul Lo�','mig',2780000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('osa',24,'Dami�','defensa',1720000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',1,'Rub�n','porter',2490000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',2,'Tito Rom�n','mig',3630000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',5,'G�lvez','defensa',1810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',6,'Rodri','defensa',1820000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',8,'Adri�n','defensa',1840000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',9,'Jos� Carlos','mig',3530000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',10,'Piti Medina','davanter',6430000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',11,'Chori Dom�nguez','mig',4030000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',13,'Dani Gim�nez','porter',390000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',14,'Arbilla','defensa',1900000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',15,'Ra�l Tamudo','mig',830000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',25,'David Cobe�o','porter',900000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',29,'L�o Baptist�o','davanter',4430000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('ray',38,'Nacho Mart�nez','mig',1130000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',5,'F�bio Coentr�o','mig',2210000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',8,'Kak�','mig',2810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',9,'Karim Benzema','davanter',5510000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',10,'Mesut �zil','davanter',5210000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',13,'Antonio Ad�n','porter',680000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',18,'Ra�l Albiol','mig',2210000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',19,'Luka Modric','mig',4110000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',20,'Gonzalo Higua�n','davanter',5810000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',21,'Jos� Mar�a Callej�n','mig',3410000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',22,'�ngel di Mar�a','mig',4610000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',25,'Diego L�pez','porter',2430000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',27,'Nacho','defensa',2720000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',29,'�lvaro Morata','mig',2010000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',33,'Fabinho','defensa',2780000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',34,'Jos� Rodr�guez','defensa',2790000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rma',35,'Jes�s','defensa',2800000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',2,'Carlos Mart�nez','mig',3090000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',3,'Mikel Gonz�lez','mig',3890000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',6,'I�igo Mart�nez','mig',4190000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',13,'E�aut Zubikarai','porter',900000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',14,'Rub�n Pardo','defensa',2540000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',20,'Jos� �ngel','defensa',2600000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('rso',21,'Diego Ifr�n','mig',3190000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',6,'Campa�a','defensa',1760000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',7,'Jes�s Navas','defensa',1770000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',8,'Gary Medel','mig',4340000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',9,'�lvaro Negredo','davanter',7540000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',17,'Javi Herv�s','defensa',1870000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',18,'Miroslav Stevanovic','defensa',1880000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',19,'Jos� Antonio Reyes','mig',3640000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',20,'Bab�','defensa',1900000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',24,'Alberto Bot�a','mig',2140000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',25,'Juli�n','defensa',1950000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('sev',28,'�lex Rubio','defensa',1980000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',6,'Jes�s Rueda','defensa',1670000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',10,'�scar Gonz�lez','davanter',5920000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',11,'Daniel Larsson','defensa',1720000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',13,'Dani Hern�ndez','porter',2250000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',16,'Llu�s Sastre','mig',3120000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',17,'Pe�a','defensa',1780000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',18,'�lvaro Rubio','defensa',1790000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',20,'Patrick Ebert','mig',3520000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',22,'V�ctor P�rez','mig',3020000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',28,'Rub�n Pe�a','defensa',1890000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',30,'Jorge Pesca','defensa',1910000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('vad',32,'Iv�n Casado','defensa',1930000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',10,'�ver Banega','mig',3500000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',11,'Pablo Piatti','mig',1900000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',12,'Jo�o Pereira','defensa',2340000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',13,'Vicente Guaita','porter',1290000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',14,'Barrag�n','defensa',2360000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',17,'Andr�s Guardado','mig',3500000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('val',18,'V�ctor Ruiz','defensa',2400000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',4,'�lvaro Gonz�lez','mig',3370000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',9,'H�lder Postiga','davanter',5970000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',10,'Apo�o','davanter',4870000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',11,'Paco Monta��s','mig',4670000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',14,'Jos� Fern�ndez','defensa',1350000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',15,'Jos� Mari','defensa',1360000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',22,'Pint�r','defensa',1430000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',23,'Javi �lamo','defensa',1440000);
...
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',26,'Ort�','defensa',1470000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',27,'H�ctor','defensa',1480000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',30,'Pablo Alcolea','porter',350000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',31,'Rub�n Rochina','mig',1570000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',32,'V�ctor Rodr�guez','mig',3370000);
INSERT INTO `jugadors` (`equip`,`dorsal`,`nom`,`lloc`,`sou`) VALUES ('zar',40,'Kilian Falc�n','defensa',1610000);
...
--1 
SELECT equipc as ec, COUNT(*) as partits, 'casa' lloc
    from partits
    where golsc is null
    group by equipc
UNION
SELECT equipf as ef, COUNT(*) as partits, 'fora' lloc
    from partits
    where golsf is null
    group by equipf
ORDER by 1, 3;
...
--2
    SELECT equipc as ec, COUNT(*) as partits, 'guanyatc' as resultat
    from partits
    where golsc > golsf
    group by equipc
    UNION
    SELECT equipc as ec, COUNT(*) as partits, 'perdutsc' as resultat
    from partits
    where golsc < golsf
    group by equipc
    UNION
    SELECT equipc as ec, COUNT(*) as partits, 'empatatc' as resultat
    from partits
    where golsc = golsf
    group by equipc
    UNION
    SELECT equipf as ec, COUNT(*) as partits, 'guanyatf' as resultat
    from partits
    where golsc > golsf
    group by equipf
    UNION
    SELECT equipf as ec, COUNT(*) as partits, 'perdutsf' as resultat
    from partits
    where golsc < golsf
    group by equipf
    UNION
    SELECT equipf as ec, COUNT(*) as partits, 'empatatf' as resultat
    from partits
    where golsc = golsf
    group by equipf
    order by 1,3;
...
--3
    SELECT Signe, COUNT(*), '1' as resultat
FROM jornades
WHERE JORNADA = 1
UNION
SELECT Signe, COUNT(*), 'X' as resultat
FROM jornades
WHERE JORNADA = 1
UNION
SELECT Signe, COUNT(*), '2' as resultat
FROM jornades
WHERE JORNADA = 1

--4

SELECT JORNADA, '1' AS Signe, SUM(CASE WHEN SIGN = '1' THEN QUANTITAT ELSE 0 END) AS Quantitat
FROM jornades
GROUP BY JORNADA
UNION
SELECT JORNADA, 'X' AS Signe, SUM(CASE WHEN SIGN = 'X' THEN QUANTITAT ELSE 0 END) AS Quantitat
FROM jornades
GROUP BY JORNADA
UNION
SELECT JORNADA, '2' AS Signe, SUM(CASE WHEN SIGN = '2' THEN QUANTITAT ELSE 0 END) AS Quantitat
FROM jornades
GROUP BY JORNADA
ORDER BY JORNADA, Signe;
