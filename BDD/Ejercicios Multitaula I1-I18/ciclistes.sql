...
insert into equips values
 ( 'Amore Vita','Ricardo Padacci'), ( 'Artiach','José Peréz'), ( 'Banesto','Miguel Echevarria'),
 ...
 ( 'Jolly Club','Johan Richard'), ( 'Kelme','Álvaro Pino'), ( 'Lotus Festina','Suarez Cuevas'),
...
(1,32,'Miguel Induráin','Banesto'),(2,35,'Pedro Delgado','Banesto'),(3,27,'Alex Zulle','ONCE'),
...
(20,29,'Alfonso Gutiérrez','Artiach'),(21,31,'Erwin Nijboer','Artiach'),(22,32,'Giorgio Furlan','Gewiss'),
...
(71,27,'Prudencio Induráin','Banesto'),(72,28,'Stefano Colage','Bresciali-Refin'),
...
( 1,9,'Valladolid','Valladolid',1), ( 2,180,'Valladolid','Salamanca',36), ( 3,240,'Salamanca','Caceres',12),
 ( 4,230,'Almendralejo','Córdoba',83), ( 5,170,'Córdoba','Granada',27), 
...
( 11,195,'Andorra','Estación de Cerler',65), ( 12,220,'Benasque','Zaragoza',12),
 ...
 ( 17,140,'Cangas de Onis','Alto del Naranco',4), ( 18,195,'Ávila','Ávila',8), 
( 19,190,'Ávila','Destilerias Dyc',2), ( 20,52,'Segovia','Destilerias Dyc',2), 
...
('MMS','Més fort','estrelles morades',2000000),
