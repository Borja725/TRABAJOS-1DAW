...
public class DBManager {
    ...
    private static final String DB_NAME = "PRG";
    private static final String DB_URL = "jdbc:mysql://" + DB_HOST + ":" + DB_PORT + "/" + DB_NAME + "?serverTimezone=UTC";
    private static final String DB_USER = "borpelmon";
    private static final String DB_PASS = "jB02529Z";
    ...
    public static void printLibro(int id) {
        try {
            ...
            int preu = rs.getInt(DB_LIB_PRE);
            
            /*
            CORREGIR - OBTENER EL NOMBRE Y PRECIO DEL LIBRO PARA IMPRIMIR    
            */
            
            System.out.println("Libro " + lid + "\t" + "nombre" + nom + "\t" + "Precio" + preu);
